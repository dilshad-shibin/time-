...
if (isset($_POST['submit']) and !empty($_POST['submit'])) {
    ...
    $mail1_subject = 'Time Thrissur enquiry from Google Ads - '.$name;
    $mail1_txt = 'Name :'.$name.'<br>'.'Mobile :'.$phone.'<br>'.'E-Mail :'.$email.'<br>'.'Course :'.$course.'<br>';
    ...
    $complete = mail('viralmafiacs2@gmail.com, cyril.viralmafia@gmail.com, trichur@time4education.com, leads.viralmafia@gmail.com', $mail1_subject, $mail1_txt, $headers);
...
if (isset($_POST['quicksubmit']) and !empty($_POST['quicksubmit'])) {
    ...
    $mail1_subject = 'Time Thrissur Quick enquiry from Google Ads - '.$name;
...
if (isset($_POST['coursesubmit']) and !empty($_POST['coursesubmit'])) {
    ...
    $mail1_subject = 'Time Thrissur Quick enquiry from Google Ads - '.$coursename;
    $mail1_txt = 'Name :'.$coursename.'<br>'.'Mobile :'.$coursephone.'<br>'.'E-Mail :'.$courseemail.'<br>'.'Course :'.$courseselect.'<br>';
...
<head>
    <meta charset="utf-8">
<title>Coaching for CAT, Bank, SSC, GMAT, GRE, IELTS</title>
...
<div class=" select_style">
                                   <div class="hover_category">
                                        <select class="select_option" name="course" required>
 <option data-display="Select Course" disabled selected>
                                                Entrance Courses</option>
...
<div class="row">
<div class="col-lg-12">
<h2 class="hm_title">Our Courses</h2>    
</div>
...
<div class="course_box_content">
 <h3>cat</h3>   
<div class="text_para"><p>T.I.M.E. is acclaimed as one of the best CAT coaching centres in Thrissur which , offers outstanding coaching for CAT and other MBA entrance exams with stunning results. It is a one-stop shop for your preparation to get into top B-Schools. </p></div>
...
<div class="course_box_content">
 <h3>IELTS</h3>   
<div class="text_para"><p>T.I.M.E, the best IELTS coaching centre in Thrissur, offers the best IELTS coaching to help students pursue their dream of getting into international universities  or for immigration.</p></div>
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="bnr_capt1">
                                ...
                                <p>Let's listen to some of the students who have lived their dreams through T. I. M. E. Thrissur.</p>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="testimonial_box tes_tri_img1">
                                <a class="bla-2" href="https://youtu.be/dYx3rD24uPI"><span><i
                                            class="fa fa-play"></i></span></a>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="testimonial_box tes_tri_img2">
                                <a class="bla-2" href="https://youtu.be/J-39Kg0MWrw"><span><i
                                            class="fa fa-play"></i></span></a>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="testimonial_box tes_tri_img3">
                                <a class="bla-2" href="https://youtu.be/nsvXcXrVCt0"><span><i
                                            class="fa fa-play"></i></span></a>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="testimonial_box tes_tri_img4">
                                <a class="bla-2" href="https://youtu.be/xQTWH846-BM"><span><i
                                            class="fa fa-play"></i></span></a>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="testimonial_box tes_tri_img5">
                                <a class="bla-2" href="https://youtu.be/_RihUBfOudQ"><span><i
                                            class="fa fa-play"></i></span></a>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="testimonial_box tes_tri_img6">
                                <a class="bla-2" href="https://youtu.be/b899dZ7HWGA"><span><i
                                            class="fa fa-play"></i></span></a>
                            </div>
                        </div>
                    </div>
        ...
        <div class="row">
            <div class="col-md-12 text-center">
                <div class="result-head">
                    <h1>Extra Ordinary Results!</h1>
                </div>
            </div>
        </div>
        <div class="row">
            <div class="col-md-4">
                <a data-fancybox="images" href="images/flyer/1.jpg">
                    <div class="achv-box">
            ...
            <div class="col-md-4">
                <a data-fancybox="images" href="images/flyer/2.jpg">
                    <div class="achv-box">
            ...
            <div class="col-md-4">
                <a data-fancybox="images" href="images/flyer/3.jpg">
                    <div class="achv-box">
                ...
                <div class="footer_copyright">
                    <div class="container">
                        <p>Copyright © 2020 Triumphant Institute of Management Education Pvt. Ltd., All rights reserved. Designed by
                            <a href="http://www.theviralmafia.com/?utm_source=time4education" target="_blank"> <img src="images/viralmafia.svg"></a> | <a href="#" class="privacy_policy" data-toggle="modal" data-target="#myModal3">Privacy Policy</a>
                        </p>
                    </div>
                </div>
            </div>
...
<div class="cour_popcont">
<h3>IELTS</h3>
<p >T.I.M.E, the best IELTS coaching centre in Thrissur, offers the best IELTS coaching to help students pursue their dream of getting into international universities  or for immigration. In addition to classroom coaching, the following supports are also provided to students in IELTS class:
</p>

<ul class="site_bult">
    <li>Small batches to ensure individual attention</li>
    <li>Language skills and IELTS training (comprising exclusive practice tests in reading comprehension, listening, speaking, and writing) by experienced faculties.</li>
    <li>Unlimited support and practice sessions </li>
    <li>Mentoring facility</li>
    <li>Excellent infrastructure</li>
    <li>Doubt clarification sessions</li>
    <li>Excellent online support</li>
