...
if(isset($_POST['submit']) and !empty($_POST['submit'])){
    ...
    $mail1_subject="Time Thrissur Bank - SSC Exam enquiry from Google Ads - " . $name;
...
if(isset($_POST['quicksubmit']) and !empty($_POST['quicksubmit'])){
    ...
    $mail1_subject="Time Thrissur Bank - SSC Exam Quick enquiry from Google Ads - " . $name;
...
if(isset($_POST['coursesubmit']) and !empty($_POST['coursesubmit'])){
    ...
    $mail1_subject="Time Thrissur Bank - SCC Exam Quick enquiry from Google Ads - " . $coursename;
...
<head>
    <meta charset="utf-8">
<title>Coaching for Bank - SSC Exam Coaching Center </title>
...
<div class="row">
<div class="col-lg-12">
<h2 class="hm_title">BANK EXAMS</h2>    
</div>  
...
<div class="text_para"><p >T.I.M.E is one of the most preferred IBPS & SBI coaching centres in Thrissur, enjoying the prestige of being one among the top bank coaching centres in Kerala, to aid those in preparation to give the Bank exams. T.I.M.E 's Bank coaching will prepare you for series of Common Written Examinations (CWEs) conducted by IBPS for the selection of personnel for Probationary Officer / Management Trainee / Clerk / Specialist, Officer posts in Public Sector banks (other than SBI) and for Officers and Office Assistants in Regional Rural Banks and exams conducted by SBI for recruitment to the posts of Clerks and Officers. T.I.M.E also enjoys the position of providing the best bank coaching centres in Kerala for online bank coaching as well.</p>
<p>Our program covers recruitment by Private banks and PSBs through one year Post Graduate Diploma in Banking and Finance (PGDBF) course in Manipal Global Education Services Pvt Ltd. Bangalore (MaGE). In addition to the Class room coaching, following supports are also provided to Bank & SSC students:</p>
</div>
...
<section>
<div class="course_sec1" id="courseID">
<div class="container">
<div class="row">
<div class="col-lg-12">
<h2 class="hm_title">SSC</h2>    
</div>  
...
<div class="course_box_content">   
<div class="text_para"><p >T.I.M.E. is not just the best SSC coaching centre in Thrissur, but is recognised as the best SSC coaching centre in Kerala. We help you crack the Combined Graduate Level Examination conducted by the SSC for recruitment to different central civil posts. T.I.M.E., the leading SSC training centre in Thrissur, helps you succeed with proper coaching, conceptual understanding, exercises, chapter-wise tests, doubt-clearing sessions, revision classes and test-taking strategies. Comprehensive study material that covers all test areas, extensive online sectional and mock tests, as well as all-India level mock tests are offered by the best SSC institute. </p>
     </div>
        ...
        <li>
        <ul class="site_bult">
        <li>As per latest pattern of exams</li>
     <li>New questions types included</li>
     <li>Detailed solutions to help analyse your performance</li>
     <li>Free GA updates - daily, weekly test and monthly updates</li>
     <li>Online test series package includes both sectional tests and online mock tests</li>
        </ul>
        </li>
        </ul>
        </div>
