...
if(isset($_POST['submit']) and !empty($_POST['submit'])){
    ...
    $mail1_subject="Time Thrissur IELTS Exam enquiry from Google Ads - " . $name;
...
if(isset($_POST['quicksubmit']) and !empty($_POST['quicksubmit'])){
    ...
    $mail1_subject="Time Thrissur IELTS Exam Quick enquiry from Google Ads - " . $name;
...
if(isset($_POST['coursesubmit']) and !empty($_POST['coursesubmit'])){
    ...
    $mail1_subject="Time Thrissur IELTS Exam Quick enquiry from Google Ads - " . $coursename;
...
<head>
    <meta charset="utf-8">
<title>Coaching for IELTS Exam Coaching Center </title>
...
<div class="text_para"><p >T.I.M.E, the best IELTS coaching centre in Thrissur, offers the best IELTS classes to help students pursue their dream of getting into international universities or for immigration. In addition to classroom coaching, the following supports are also provided to students at the best IELTS training centre in Kerala.</p></div>
